...
public class CreateMap : MonoBehaviour
{
    ...
    private void CreateMaps()
    {
        ...
        if (player.transform.position.x / 13f >= createdMapCnt)
        {
            ...
            Vector3 point = new Vector3(player.transform.position.x + 38f, 0f, 20f);
    ...
    private void CreateEnemy()
    {
        ...
        enemyAppear = new Vector3(enemyOffset + PlayerMove.MoveSpeed * createdEnemyCnt +
            PlayerMove.MoveSpeed * gm.offset + PlayerMove.MoveSpeed * 60f / 60f / 2f, 0f, 20f);
